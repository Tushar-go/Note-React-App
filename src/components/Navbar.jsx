...
//             </svg>
//         </div>
//         <input type="search" class="block w-full py-2 px-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " placeholder="Search Mockups, Logos..." required />
        
//     </div>
// </form>

//       <button type="button" className="text-black bg-gray-200 hover:bg-gray-50  font-semibold rounded-lg text-sm px-6 py-2 me-2 mb-2 ">Add</button>
//     </div>
//   </header>
//   )
// }
